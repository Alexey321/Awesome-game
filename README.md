...
Створюемо прототип гри у 2d вимiрi для того щоб максимально зусередитись на логiцi программи. Найскладнiша частина це алгоритм захоплення поля. Алгоритм дуже сложий на заливку зоображення кольором. Алгоритм виконан рекурсивно.
